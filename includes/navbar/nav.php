<nav class="bg-white dark:bg-dark-secondary shadow-md py-4">
    <div class="container mx-auto px-4 flex justify-between items-center flex-wrap">
        <div class="flex items-center space-x-3 mb-4 md:mb-0">
            ...
            <a href="#" class="text-2xl font-extrabold text-primary dark:text-primary hover:opacity-80 transition-opacity">SSSAK Elections</a>
        </div>

        <div class="flex items-center space-x-4">
            <a href="#" class="bg-primary text-white px-5 py-2.5 rounded-lg hover:bg-primary-dark transition flex items-center text-base font-semibold shadow-md">
