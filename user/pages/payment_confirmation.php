<div id="payment-processing-animation" class="text-center py-10">
    ...
    <div class="receipt bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md p-6 mx-auto max-w-lg mb-6">
        ...
        <div class="border-t border-b border-gray-200 dark:border-gray-700 py-4 mb-4">
            <div class="grid grid-cols-2 gap-2 text-sm">
                <div>
                    <p><span class="font-medium">Receipt No:</span> <span id="receipt-number"></span></p>
                    <p><span class="font-medium">Date:</span> <span id="receipt-date"></span></p>
                    <p><span class="font-medium">Time:</span> <span id="receipt-time"></span></p>
                </div>
                <div>
                    <p><span class="font-medium">Payment Method:</span> <span id="receipt-method"></span></p>
                    <p><span class="font-medium">Transaction ID:</span> <span id="receipt-transaction"></span></p>
        ...
        <div class="mb-4 text-sm">
            <p><span class="font-medium">Candidate:</span> <span id="receipt-name"></span></p>
            <p><span class="font-medium">Student ID:</span> <span id="receipt-studentid"></span></p>
            <p><span class="font-medium">Institution:</span> <span id="receipt-institution"></span></p>
            <p><span class="font-medium">Position:</span> <span id="receipt-position"></span></p>
        </div>
