...
<form id="candidate-form" class="space-y-4">
    ...
    <div>
        ...
        <select id="position" name="position" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary dark:bg-gray-700 dark:border-gray-600 text-base" required>
            ...
            <option value="president" data-fee="2000">President (KES 2,000)</option>
            <option value="vicePresident" data-fee="1500">Vice President (KES 1,500)</option>
            <option value="secretary" data-fee="1200">Secretary General (KES 1,200)</option>
            <option value="treasurer" data-fee="1200">Treasurer (KES 1,200)</option>
            <option value="organizer" data-fee="1000">Events Organizer (KES 1,000)</option>
            <option value="representative" data-fee="800">Student Representative (KES 800)</option>
        </select>
    </div>
